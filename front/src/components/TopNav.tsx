...
function TopNav() {
  return (
    <nav className='border-b-2 sticky top-0 z-10 bg-white w-full flex justify-between items-center px-4 py-2'>
      <div className='left'>
        <Button className='bg-transparent'>
          <img src="/fb_icon.svg" alt="" />
        </Button>
        <input type="text" placeholder='Search here' />
      </div>

      <div className="mid space-x-6">
        <Button className='bg-transparent'>
      ...
      <div className="right space-x-6">
        ...
        <Button className='bg-transparent'>
          <img src="/dragon.jpg" width="41" height="41" style={{borderRadius: "50%"}} alt="" />
        </Button>
      </div>
    </nav>
  );
